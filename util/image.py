...
def save_cycle_consistent_images(real_a, real_a_to_b, real_b_to_a, real_b, real_b_to_a_to_b, real_a_to_b_to_a, epoch, i, run_name):
    # Select the first image in the batch for each tensor
    real_a = real_a[0]
    real_a_to_b = real_a_to_b[0]
    real_b_to_a = real_b_to_a[0]
    real_b = real_b[0]
    real_b_to_a_to_b = real_b_to_a_to_b[0]
    real_a_to_b_to_a = real_a_to_b_to_a[0]
